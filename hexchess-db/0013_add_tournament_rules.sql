...
ALTER TABLE tournament_matches ADD COLUMN white_id BIGINT NOT NULL REFERENCES users(id) default 0;
ALTER TABLE tournament_matches ADD COLUMN black_id BIGINT NOT NULL REFERENCES users(id) default 0;
