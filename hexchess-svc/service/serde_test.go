...
func TestChessSerializer(t *testing.T) {
	...
	input1 := MakeChessState(StateSetup{ID: uuid.NewString(), Mode: domain.ModeCorrespondence1, FirstColor: domain.Random})
	input1.EndState = Finished

	input2 := MakeChessState(StateSetup{ID: uuid.NewString(), Mode: domain.ModeCorrespondence1, FirstColor: domain.Random})
...
func BenchmarkProtoChessSerializer(b *testing.B) {
	input := MakeChessState(StateSetup{ID: uuid.NewString(), Mode: domain.ModeCorrespondence1, FirstColor: domain.Random})
