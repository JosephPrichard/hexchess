...
func TestActiveUser(t *testing.T) {
	...
	services.EntropySource = &StableEntropySource{Time: time.UnixMilli(int64(ActiveUserMaxage * 2))}
	...
	services.EntropySource = &StableEntropySource{Time: time.UnixMilli(int64(ActiveUserMaxage * 3))}
